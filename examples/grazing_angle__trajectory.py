...
crossing_middle_time = crossing["Start Time"] + (crossing["End Time"] - crossing["Start Time"]) / 2

crossing_position = traj.Get_Position("MESSENGER",
...
ax.scatter(crossing_position[0],
